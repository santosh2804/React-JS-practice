...
class Gallery extends Component {
  ...
  render() {
    const {activeImageId} = this.state
    const activeImageDetails = this.displayingImageUrl()
    const {imageUrl, imageAltText} = activeImageDetails[0]
    return (
      <div className="container">
        <img src={imageUrl} className="primary-image" alt={imageAltText} />
        ...
        <ul className="thumbnail-items-container">
          {imagesList.map(eachImage => (
            <ThumbnailItem
              ...
              changeActivethumbnail={this.changeActivethumbnail}
